...
set -o pipefail && xcodebuild -project "$standalone_folder/Builds/MacOSX/HISE Standalone.xcodeproj" -configuration "$BUILD_CONFIG" -jobs 4 GCC_PREPROCESSOR_DEFINITIONS="NUM_MAX_CHANNELS=8" | ./tools/Projucer/xcbeautify --renderer github-actions
